          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="newproduct_form.php">New Product</a>
                </li>
                <li class="nav-item">
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input name="lname" type="text" class="form-control" id="exampleInputName2" placeholder="LName">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input  name="pass" type="password" class="form-control" id="exampleInputPassword4" placeholder="Password">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName2">Position</label>
                      <input name="position" type="text" class="form-control" id="exampleInputPosition" placeholder="Position">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input  name="picture" type="file" class="file-upload-defaultff">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleTextarea1" name="description" rows="2"></textarea>
                    </div>
